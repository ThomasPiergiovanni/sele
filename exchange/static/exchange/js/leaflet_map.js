...
info.update = function (props) {
    this._div.innerHTML = '<h6 class="ml-1 mt-2 text-secondary"><b>Commune</b></h6>' + (props ?
        '<p class="ml-1 mr-1 text-dark"><b><span class="text-primary">' + props.nom + '</span></b> (' + props.insee +').'+
